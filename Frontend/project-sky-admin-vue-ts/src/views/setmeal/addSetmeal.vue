  ...
  <div class="addBrand-container">
    <div class="container">
      <el-form ref="ruleForm"
        ...
        <div>
          <el-form-item label="Meal price:"
                        prop="price">
            <el-input v-model="ruleForm.price"
                      placeholder="Please set meal price" />
          </el-form-item>
        </div>
        <div>
          <el-form-item label="Dishes in Meal:"
                        required>
            <el-form-item>
              <div class="addDish">
        ...
        <div>
          <el-form-item label="Meal picture:"
                        required
                        prop="image">
            <image-upload :prop-image-url="imageUrl"
                          @imageChange="imageChange">
              The image size should not exceed 2M<br>Only PNG, JPEG, and JPG images can be uploaded<br>It is recommended to upload images with a size of 200*200 or 300*300
            </image-upload>
          </el-form-item>
        </div>
        <!-- <el-form-item
        ...
        <div class="address">
          <el-form-item label="Meal description:">
            <el-input v-model="ruleForm.description"
                      type="textarea"
                      :rows="3"
                      maxlength="200"
                      placeholder="Meal description, up to 200 characters" />
          </el-form-item>
        </div>
    ...
    <el-dialog v-if="dialogVisible"
      ...
      <el-input v-model="value"
                class="seachDish"
                placeholder="Please enter dish name to search"
