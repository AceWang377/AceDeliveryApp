  ...
  <div class="dashboard-container">
    <div class="container">
      <div class="tableBar">
        ...
        <label style="margin-right: 10px; margin-left: 20px">Meal Type：</label>
...
export default class extends Vue {
  ...
  private deleteHandle(type: string, id: any) {
    ...
    this.$confirm('Confirm delete meal?', 'Confirm delete', {
  ...
  private statusHandle(row: any) {
    ...
    if (typeof row === 'string') {
      if (this.checkList.length == 0) {
        this.$message.error('For batch operation, please select the operation dishes first！')
        return false
      }
    ...
    this.$confirm('Confirm to change the status of this meal?', 'Warning', {
      ...
      setmealStatusByStatus(params)
        .then(res => {
          if (res.data.code === 1) {
            this.$message.success('Meal status set up success！')
            this.init()
          } else {
            this.$message.error(res.data.msg)
          }
