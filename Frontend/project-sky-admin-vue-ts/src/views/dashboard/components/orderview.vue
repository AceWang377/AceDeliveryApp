  ...
  <div class="container">
    ...
    <div class="orderviewBox">
      <ul>
        <li>
          <span class="status"
            ><i class="iconfont icon-waiting"></i>Awaiting orders</span
          >
          <span class="num tip"
        ...
        <li>
          <span class="status"
            ><i class="iconfont icon-complete"></i>Finish</span
          >
          <span class="num"
        ...
        <li>
          <span class="status"><i class="iconfont icon-cancel"></i>Canceled</span>
          <span class="num"
