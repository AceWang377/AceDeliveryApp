  ...
  <div>
    <div class="container homecon">
      ...
      <div class="">
        <div v-if="orderData.length > 0">
          ...
          >
            <el-table-column prop="number" label="No. Order"> </el-table-column>
            <el-table-column label="Order Dish">
        ...
        <div class="order-middle">
          <div class="user-info">
            <div class="user-info-box">
              ...
              >
                <label>{{
                  dialogOrderStatus === 5 ? 'Delivery Time：' : 'Estimate Delivery Time：'
                }}</label>
                <span>{{
                  dialogOrderStatus === 5
          ...
          <div class="amount-info">
            ...
            <div class="amount-list">
              <div class="dish-amount">
                <span class="amount-name">Dish Total：</span>
              ...
              <div class="send-amount">
                ...
                <span class="amount-price">GBP{{ 6 }}</span>
              </div>
    ...
    >
      <el-form label-width="90px">
        <el-form-item :label="cancelDialogTitle + 'Reson：'">
          <el-select
        ...
        <el-form-item v-if="cancelReason === 'Custom Reason'" label="Resson：">
          <el-input
            v-model.trim="remark"
            type="textarea"
            :placeholder="'Please enter your' + cancelDialogTitle + 'reason（20 words limit）'"
            maxlength="20"
          />
        </el-form-item>
      </el-form>
...
export default class extends Vue {
  ...
  private cancelrReasonList = [
    {
      value: 1,
      label: 'There are too many orders and we are temporarily cannot accept order a the moment',
    },
    {
      value: 2,
      label: 'The dishes are sold out and we are temporarily unable to accept orders.',
