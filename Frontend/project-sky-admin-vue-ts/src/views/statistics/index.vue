...
export default class extends Vue {
  ...
  async getTurnoverStatisticsData(begin: any ,end:any) {
    console.log('[CALL] getTurnoverStatisticsData →', { begin, end })
  ...
  console.log('👉 tateData:', this.tateData)
  console.log('👉 tateData[0]:', this.tateData[0])
  console.log('👉 tateData[1]:', this.tateData[1])
