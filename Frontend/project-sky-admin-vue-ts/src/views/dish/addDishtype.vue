  ...
  <div :key="vueRest"
    ...
    <div :key="restKey"
      ...
      <el-form ref="ruleForm"
        ...
        <el-form-item label="Flavor setting:">
          <el-form-item>
            <div class="flavorBox">
              ...
              <div v-if="dishFlavors.length != 0"
                   class="flavor">
                <div class="title">
                  <span>Flavor Name（3 words limits）</span>
        ...
        <div>
          <el-form-item label="Dish Picture:"
                        prop="image">
        ...
        <div class="address">
          <el-form-item label="Dish Description:"
            ...
            <el-input v-model="ruleForm.description"
                      ...
                      :rows="3"
                      maxlength="200"
                      placeholder="Dish description, up to 200 characters" />
          </el-form-item>
        </div>
