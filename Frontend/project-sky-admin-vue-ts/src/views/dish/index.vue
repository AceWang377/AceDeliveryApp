    ...
    <div class="container">
      <div class="tableBar">
        ...
        <el-input v-model="input"
                  placeholder="Please select dish name"
                  style="width: 14%"
                  clearable
                  @clear="init"
                  @keyup.enter.native="initFun" />

        <label style="margin-right: 10px; margin-left: 20px">Dish Type：</label>
        ...
        <div class="tableLab">
          <span class="delBut non"
                @click="deleteHandle('批量', null)">Batch Delete</span>
        ...
        <el-table-column label="Operation"
          ...
          <template slot-scope="scope">
            ...
            <el-button type="text"
              ...
              {{ scope.row.status == '0' ? 'On Sale' : 'Unavailable' }}
            </el-button>
          </template>
        </el-table-column>
      </el-table>
